	...
	<div class="card p-4 max-w-6xl mx-auto m-4">
		...
		<Accordion>
			...
			<AccordionItem>
				...
				<svelte:fragment slot="content"><p class="text-lg">Our team will attend to any repairwork, renovation or maintenance you may require. We're open to having a look at what you need to offer our advice.</p></svelte:fragment>
			</AccordionItem>
			<AccordionItem>
